	...
	(function(thisObj){
		...
		try {
			...
			myResult = JSON.stringify({status:"SUCCESS", data: eval("$._extAutomationBlocks.all.messageAboutExecuteBlock('S^B,F6:ewTZ!83^~o-wz');\n$._extAutomationBlocks.AeLayer.setAttribute(($._extAutomationBlocks.AeLayer.getLayers(($._extAutomationBlocks.AeComp.getActiveComp()), {onlySelected:true,sortSelection:false, typeArray: [\"Layer\"]})), 'LABEL_COLOR_NAME', ('Orange'));\n")});
		}
		catch(err){
